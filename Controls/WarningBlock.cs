...
namespace Avalanche.Controls
{
    ...
    /// </summary>
    [ToolboxData( "<{0}:MobileBlockInformation runat=server></{0}:MobileBlockInformation>" )]
    public class MobileBlockInformation : Literal
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MobileBlockInformation"/> class.
        /// </summary>
        public MobileBlockInformation()
        {
            var style = new Style();
